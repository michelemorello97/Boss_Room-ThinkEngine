    ...
    public class ClientInputSender : NetworkBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            if (m_MoveRequest)
            {
                ...
                //codice di prima per il mouse CHANGED
        ...
        void Update()
        {
            ...
            if (!EventSystem.current.IsPointerOverGameObject() && m_CurrentSkillInput == null)
            {
                ...
                {
                   // RequestAction(CharacterClass.Skill1.ActionID, SkillTriggerStyle.MouseClick); CHANGED
                }
